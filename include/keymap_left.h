...
const keycode_t KEYMAP[KEYMAP_LAYERS][MATRIX_ROWS][MATRIX_COLS] PROGMEM = {
  ...
  // 1 - to be filled in
  {
    { KC_ESCAPE,  KC_NONE, KC_NONE,  KC_NONE, KC_NONE,     KC_NONE,   KC_LAYER_0 },
    { KC_NONE,    KC_NONE, KC_NONE,  KC_NONE, KC_NONE,     KC_NONE,   KC_LAYER_1 },
    { KC_NONE,    KC_NONE, KC_NONE,  KC_NONE, KC_NONE,     KC_NONE,   KC_NONE },
    { KC_NONE,    KC_NONE, KC_NONE,  KC_NONE, KC_NONE,     KC_NONE,   KC_NONE },
    { KC_NONE,    KC_NONE, KC_NONE,  KC_NONE, KC_DELETE,   KC_BSPACE, KC_NONE },
  }
};
